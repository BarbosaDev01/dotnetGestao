...
namespace WebApplication1.Controllers
{
    public class acaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAcao,selecionarProjeto,adicionarAcao,dataHora,statusAcao,emailUsuario,IdProjeto,IdUsuario")] acao acao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAcao,selecionarProjeto,adicionarAcao,dataHora,statusAcao,emailUsuario,IdProjeto,IdUsuario")] acao acao)
        {
            if (id != acao.IdAcao)
            {
                return NotFound();
